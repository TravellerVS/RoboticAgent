...
public class BasicAgent extends Agent implements Observer{
    ...
    void Start() {
        ...
        while(true) {
            ...
            if(behavior instanceof BasicBehaviorFinished)
            {
    ...
    private void SetUpBehaviors() {        
        ...
        behaviorList.AddBehavior(new BasicBehaviorFinished(movements, sensors) , i--);
        ...
        behaviorList.AddBehavior(new BasicBehaviorWounder(movements, sensors) , i--);
    }
}
